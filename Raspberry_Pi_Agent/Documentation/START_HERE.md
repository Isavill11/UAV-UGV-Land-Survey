...
## 1️⃣ SYSTEM_OVERVIEW.md  (Understand the Architecture)
...
## 2️⃣ CONFIGURATION_REFERENCE.md  (Understand Tuning Parameters)
...
## 3️⃣ DEPLOYMENT_AND_TESTING.md  (Run the System Safely)
...
## 4️⃣ IMAGE_STORAGE_AND_TRANSMISSION.md  (Image Subsystem)
...
└── IMAGE_STORAGE_AND_TRANSMISSION.md
